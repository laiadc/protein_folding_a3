...
class TomographyMeasurements():
    ...
    def __init__(self,
        ...
        if self.var_form.num_parameters==0 and self.parameters is not None:
        ...
        if self.var_form.num_parameters!=0 and self.parameters is None:
    ...
    def sample_circuit_measurements(self,
        ...
        for measurement_basis in measurement_bases:
            ...
            basis_op = Pauli(measurement_basis)
